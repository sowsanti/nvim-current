...
return packer.startup(function(use)
	...
	use("ryanoasis/vim-devicons") -- icons for netrw
	...
	use("windwp/nvim-autopairs") -- auto close parenthesis etc
	use("windwp/nvim-ts-autotag") -- auto close ts tags
	...
	-- better file explorer (netrw)
	use("tpope/vim-vinegar")
	-- git modifications highligter
